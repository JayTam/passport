<template>
  ...
  <div class="content">
    <te-button
      ...
      block
      dark
      :to="{ name: 'VerificationPhone' }"
    >
      {{ $t("Auth.PhoneVerification") }}
    </te-button>
    <te-button type="warning" block dark :to="{ name: 'VerificationEmail' }">
      {{ $t("Auth.EmailVerification") }}
    </te-button>
  </div>

  <te-button type="primary" plain size="mini" :to="{ name: 'LoginAccount' }" replace class="btn"
